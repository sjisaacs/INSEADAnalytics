...
Yahoo! ticker symbol: YHOO. Add YHOO as 3rd element of 'mytickers' vector: `mytickers = c("SPY", "AAPL", "YHOO")`, rerun dataSet1 to recreate 'StockPrices' matrix.

And therefore YHOO price data is populated in the 3rd column of 'StockPrices' matrix. Then,
