...
Yahoo! ticker symbol: YHOO. Add YHOO as 3rd element of 'mytickers' vector, and therefore 3rd column of 'StockPrices' matrix. Then,

YHOO Cumulative Returns: round(100*sum(StockReturns[,3]),1) = 289%

YHOO Average Daily Returns: round(100*mean(StockReturns[,3]),3) = 0.072%

YHOO Standard Deviation: round(100*sd(StockReturns[,3]),3) = 3.02%
