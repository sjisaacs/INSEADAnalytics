...
local_directory <- "/Users/Steve/Documents/INSEAD/P3/BDAB/INSEADAnalytics/"
...
colnames(thecor_thres)<-colnames(ProjectDataFactor)
rownames(thecor_thres)<-colnames(ProjectDataFactor)
...
2. There is some underlying factor (or independent variable) which often drives similar responses to pairs of questions listed above.
...
**Your Answers here:**
1. The table displays 29 new factors, each generated as a linear combination (approximately) of the original 29 attributes. The factors are determined on the basis of retaining as much of the original information in as few factors as possible. The plot shows the same information graphically, plotting each new factor's eigenvalue.

2. The new factors are ordered from highest eigenvalue to lowest; hence the scree plot will always be decreasing from left to right (or flat). This specific shape is due to the fact that some factors describe more variation than the original attributes, and therefore later factors contain less information than the original attributes.

3. Few components above the ab-line, i.e. few eigenvalues > 1. This allows us to simplify our collection of attributes greatly while retaining most of the information. In this case, the scree plot will have a very steep gradient / sharp "elbow".
...
**Your Answers here:**
1. 
* Factor 1: "Image & Status"
* Factor 2: "Escapism & Reward"
* Factor 3: "Boating Expertise"
* Factor 4: "Brand Consciousness"
* Factor 5: "Functionality"

2. 5; overlap is minimal and eigenvalues are all above 1. Secondly, the question groupings make sense, as described above. Thirdly, these factors are actionable and allows us to make business decisions with respect to marketing decisions, customer behaviour, etc. 

The additional information explained by adding extra factors is small.

3. See 1

4. Data science is actually a science AND an art.
